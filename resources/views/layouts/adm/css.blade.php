    ...
    <!-- Toastr -->
    <link rel="stylesheet" href="{{ asset('adm') }}/plugins/toastr/toastr.min.css">
    <!-- Select2 -->
    ...
    <!-- BS Stepper -->
    <link rel="stylesheet" href="{{ asset('adm') }}/plugins/bs-stepper/css/bs-stepper.min.css">
    <!-- dropzonejs -->
    <link rel="stylesheet" href="{{ asset('adm') }}/plugins/dropzone/min/dropzone.min.css">
